/**
 * HardwareModal — Triggered when a sensor returns null data.
 * Directs user to contact support at 0774694160.
 */
  ...
  return (
    <div className="hw-modal-overlay" onClick={onClose}>
      <div className="hw-modal fade-in" onClick={e => e.stopPropagation()}>
        ...
        <p className="hw-modal-sensor">
          Sensor <span>{sensorIndex + 1}</span> — {sensorName || `Channel ${sensorIndex + 1}`}
        </p>
        <p className="hw-modal-desc">
          No data received from this sensor. This may indicate a wiring fault, 
          a disconnected CT clamp, or an ADC failure on the ESP32 controller.
        </p>
        <div className="hw-modal-contact">
          <div className="hw-modal-contact-label">Contact ZEC-5 Support</div>
